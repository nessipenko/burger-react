    ...
    <footer class={style.footer}>
      <Container class="container">
        <div class={style.footer__content}>
          <img
            class={style.footer__log}
            src={logo}
            alt="Логотип YourMeal"
          />

          <address class={style.footer__address}>
            <div class={style.footer__contact}>
              <h2 class={style.footer__title}>Номер для заказа</h2>

              <a
                class={style.footer__phone}
            ...
            <div class={style.footer__contact}>
              <h2
                class={classNames(style.footer__title, style.footer__title_sn)}
              >
                Мы в соцсетях
              </h2>
          ...
          <div class={style.footer__development}>
            <p>© YouMeal, 2022</p>
            <p>
